<template>
  <section class="w-full h-screen flex justify-center content-center bg-gray-50">
    <form @submit.prevent="login" ref="loginForm" class="rounded bg-white w-fit h-fit p-6 shadow-md">
      ...
      <div class="mt-4 mb-2 flex justify-center">
        <button type="submit" name="submit" class="btn-submit" :disabled="loading">
